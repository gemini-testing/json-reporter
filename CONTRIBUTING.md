...
All bug fixes and new features should go to the [`master`](https://github.com/gemini-testing/json-reporter/tree/master) branch.
...
1. [Search](https://github.com/gemini-testing/json-reporter/issues) for same issues on github in order to prevent duplicates
